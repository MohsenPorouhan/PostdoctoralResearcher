 ...
 *
 * Author: Edi Modriؤ‡ <edi.modric@gmail.com>
 */
(function ($) {
    "use strict";
    ...
    $.extend($.fn.select2.defaults, {
        ...
        formatInputTooShort: function (input, min) {
            ...
            if (nMod10 > 0 && nMod10 < 5) {
                return "Unesite joإ، " + n + " " + specialNumbers[nMod10](n);
            }

            return "Unesite joإ، " + n + " znakova";
        },
        ...
        formatLoadMore: function (pageNumber) { return "Uؤچitavanje rezultata..."; },
