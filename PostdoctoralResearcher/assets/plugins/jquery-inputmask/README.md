...
```javascript
$(document).ready(function(){
    $(selector).inputmask('â‚¬ 999.999.999,99', { numericInput: true });    //123456  =>  â‚¬ ___.__1.234,56
});
```
...
```javascript
$(document).ready(function(){
    $(selector).inputmask('â‚¬ 999.999.999,99', { numericInput: true, radixPoint: "," });
});
```
...
```javascript
var phones = [
            { "mask": "+247-####", "cc": "AC", "name_en": "Ascension", "desc_en": "", "name_ru": "ذ‍رپر‚ر€ذ¾ذ² ذ’ذ¾ذ·ذ½ذµرپذµذ½ذ¸رڈ", "desc_ru": "" },
            { "mask": "+376-###-###", "cc": "AD", "name_en": "Andorra", "desc_en": "", "name_ru": "ذگذ½ذ´ذ¾ر€ر€ذ°", "desc_ru": "" },
            { "mask": "+971-5#-###-####", "cc": "AE", "name_en": "United Arab Emirates", "desc_en": "mobile", "name_ru": "ذ‍ذ±رٹذµذ´ذ¸ذ½ذµذ½ذ½ر‹ذµ ذگر€ذ°ذ±رپذ؛ذ¸ذµ ذ­ذ¼ذ¸ر€ذ°ر‚ر‹", "desc_ru": "ذ¼ذ¾ذ±ذ¸ذ»رŒذ½ر‹ذµ" },
          ...
]
