	...
	(function ($) {
		...
		$.vakata.context = {
			...
			_show_submenu : function (o) {
				...
				// ذ¼ذ¾ذ¶ذµ ذ´ذ° رپذµ رپذ؟ذµرپر‚ذ¸ ذµ ذµذ´ذ½ذ° ذ؟ر€ذ¾ذ²ذµر€ذ؛ذ° - ذ´ذ°ذ»ذ¸ ذ½رڈذ¼ذ° ذ½رڈذ؛ذ¾ذ¹ ذ¾ر‚ ذ؛ذ»ذ°رپذ¾ذ²ذµر‚ذµ ذ²ذµر‡ذµ ذ½ذ°ذ³ذ¾ر€ذµ
				if(right_to_left) {
			...
			vakata_context.element
				.on("mouseenter", "li", function (e) {
					...
					if($.contains(this, e.relatedTarget)) {
						// ذ؟ر€ذµذ¼ذ°ر…ذ½ذ°ر‚ذ¾ ذ·ذ°ر€ذ°ذ´ذ¸ delegate mouseleave ذ؟ذ¾-ذ´ذ¾ذ»رƒ
				...
				// ر‚ذµرپر‚ذ¾ذ²ذ¾ - ذ´ذ°ذ»ذ¸ ذ½ذµ ذ½ذ°ر‚ذ¾ذ²ذ°ر€ذ²ذ°?
