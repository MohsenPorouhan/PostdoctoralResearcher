...
var App = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('.page-sidebar, .header').on('click', '.sidebar-toggler', function (e) {
            ...
            debugger;
            if($(".highcharts-container ") && $(".highcharts-container svg")){
            var availableWidth = $(".highcharts-container").parent().parent().innerWidth()-20;
            $(".highcharts-container svg").attr("width",availableWidth);
            $(".highcharts-container ").css("width",availableWidth);
