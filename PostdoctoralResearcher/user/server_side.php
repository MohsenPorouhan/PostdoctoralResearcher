...
include("include/include.phtml");
	...
	$sQuery = "
		...
		FROM   $sTable
		WHERE  archieved='0' and tarh_type!='6' and is_tarh='1'  and   submission_status ='0' and confirm_moaven_tarh='1'  and ready_gharardad='0'   and tarh.version='-1' and tarh.cod_daneshkade=daneshkade.cod_daneshkade 
		$sWhere
		group by cod_tarh
		$sOrder
		$sLimit
