...
if(isset($action))
{
    ...
    $form_rezayatname=substr_replace($form_rezayatname,"a0=0",0,4);
	$query="update tarh set form_rezayatname='$form_rezayatname' where cod_tarh='$cod_tarh' and version='-1'";
	//echo $query;
  	$tarh_result=mysql_query($query) or die("Error in selecting data into tarh");
...
<?
$i=check_field_value($form_rezayatname,"a0");
if($i=="1")
  ...
  echo "<tr><td class='tahoma1' align='right' width='20%'><input type='radio' $select name='a0' value='1'>بلي</td></tr>";
  
  if($i=="0")
  	$select="checked=\"checked\"";
  else
  	$select="";
  echo "<tr><td class='tahoma1' align='right' width='20%'><input type='radio' $select name='a0' value='0'>خير</td></tr>";
