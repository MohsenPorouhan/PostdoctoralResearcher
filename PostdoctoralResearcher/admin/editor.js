...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
// PersianArea v1.0 - Copyright (c) 2002 ASP-Rider.com.
//
// A free WYSIWYG editor replacement for <textarea> fields Plus Persian Compabilities.
// For full source code and docs about PersianArea visit http://www.ASP-Rider.com/
//----------------------------------------------------------------------
//----------------------------------------------------------------------
...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'background-color: #FFFFFF; font-family: "Tahoma";direction:rtl; font-size: 11;';
...
//    ['linebreak'],
    ...
    ['justifyleft','justifycenter','justifyfull','justifyright','separator'],
    ['linebreak'],
...
//    "saveas":         ['SaveAs',               'Save As...',         'editor_action(this.id)',  'ed_saveas.gif'],
    ...
    "farsi":           ['farsi',         'Change Language',  'editor_action(this.id)',  'fa1.gif'],
    "dirright":        ['BlockDirRtl',         'Right to Left',  'editor_action(this.id)',  'rtl.gif'],
    "dirleft":         ['BlockDirLtr',         'Left to Right',  'editor_action(this.id)',  'ltr.gif'],
   // end: custom buttons
...
function editor_generate(objname,userConfig) {
  ...
  var tblOpen  = '<table border=0 cellspacing=0 cellpadding=0 style="float: right;"  unselectable="on"><tr><td style="border: none; padding: 1 0 0 0"><nobr>';
...
function editor_action(button_id) {
  ...
  // Custom1
	...
	langFarsi=!langFarsi;
	langFarsi?document.forms[0].farsi.src="images/fa1.gif":document.forms[0].farsi.src="images/en.gif";
  }

  // Custom2
  else if (cmdID == 'lef') {             
	document.forms[0].yourFieldNameHere.style.direction='ltr'
  }

  // Custom3
  else if (cmdID == 'righ') {            
	document.forms[0].yourFieldNameHere.style.direction='rtl'
  }
...
//--------------------------------------------------
   ...
   if (key < 0x0020 || key >= 0x00FF){
      ...
      editEvent.keyCode = farsikey[key - 0x0020];
   }
   return true;
	}
//--------------------------------------------------
...
function editor_filterOutput(objname) {
  ...
  if (contents.toLowerCase() == '<p dir=rtl>&nbsp;</p>') { contents = ""; }
...
function editor_cMenu_generate(editorWin,objname) {
  ...
  var cMenuHeader = ''
    ...
    + '<table dir=rtl border=0 cellspacing=0 cellpadding=0 width="100%" style="width: 167px; background-color: threedface; border: solid 1px; border-color: threedhighlight threedshadow threedshadow threedhighlight;">'
