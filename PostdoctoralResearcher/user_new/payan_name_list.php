...
include("include/include.phtml");
	...
	if($la=="en")
	{
		...
		$uni="daneshkade_name";
	$aColumns = array( 'cod_tarh','tarh_title_farsi',"$uni",'tarh_time','accepttarh');
...
// 	}
	...
	$sQuery = "
		...
		FROM   $sTable
		WHERE indoing='0' and  payannameh='1' and   is_tarh='0' and ready_gharardad='0' and tarh.creator = '$admin'  and version='-1' and tarh.cod_daneshkade=daneshkade.cod_daneshkade
		$sWhere
		group by cod_tarh
		$sOrder
		$sLimit
...
$sQuery = "
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$accepttarh=$aRow["accepttarh"];
		
		if($la=="en")
		{
			$accept_txt="Confirmation Supervisor";
			$accept_txt2="Awaiting confirmation supervisor";
		}
		else
		{
			$accept_txt="تاييديه استاد راهنما";
			$accept_txt2="منتظر تاييد استاد راهنما";
		}
		...
		//$accept= iconv('windows-1256', 'utf-8', $accept); 
		$row["accept"]=$accept;
		$cntr++;
		$row["edit"]=$edit;
		$row["ss"]=null;
